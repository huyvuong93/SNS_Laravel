<template>
    ...
    <BreezeAuthenticatedLayout>
        <div class="grid grid-cols-3 gap-1 max-w-7xl">
            ...
            <div class="py-12 col-span-2">
                <div class="w-full mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white overflow-y-scroll shadow-sm sm:rounded-lg mb-4"
                        ...
                        <div class="p-4 bg-white border-b border-gray-200">
                            <div>
                                <div class="flex justify-between">
                                    ...
                                    <BreezeDropdown>
                                        <template #trigger>
                                            <div class="z-0" v-if="post.user.id === user.id" @click="showMenu(post)">...</div>
                                        </template>
                                        <template #content>
                                            <div class="py-2">
    ...
    mounted() {
        ...
        window.addEventListener('scroll', debounce((e) => {
            if ((window.innerHeight + window.scrollY) >= document.body.scrollHeight) {
                axios.get(`/mypage/?page=${this.page}`).then(response => {
